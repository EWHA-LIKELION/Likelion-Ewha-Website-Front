    ...
    <>
      ...
      <ActivitySection>
        <ActivityInner>
          ...
          <ActivityGrid>
            ...
            <ActivityColumn>
              <ActivityBox color="#EFFFF0" $border="#05DA5B">
                교육 세션 (3-6월)
              </ActivityBox>
              <ActivityBox color="#EFFFF0" $border="#05DA5B">
                토이 프로젝트 세션 (3-6월)
              </ActivityBox>
              <ActivityBox color="#FFF8ED" $border="#FF7B2E">
                중앙 아이디어톤
                <br />
                (4월 말-5월 말, 전국 대학 81개 연합)
              </ActivityBox>
            </ActivityColumn>

            <ActivityColumn>
              <ActivityBox color="#FFF8ED" $border="#FF7B2E">
                여기톤 (7월 초, 서울권 여대 6개 연합)
              </ActivityBox>
              <ActivityBox color="#FFF8ED" $border="#FF7B2E">
                중앙 해커톤 (7-8월, 전국 대학 81개 연합)
              </ActivityBox>
              <ActivityBox color="#FFF8ED" $border="#FF7B2E">
                신촌톤 (8월 말, 신촌권 대학 4개 연합)
              </ActivityBox>
            </ActivityColumn>
            ...
            <ActivityColumn>
              ...
              <ActivityBox color="#EFFFF0" $border="#05DA5B">
                대동제 리디자인 (9월, 기획·디자인 파트)
              </ActivityBox>
              <ActivityBox color="#FFF8ED" $border="#FF7B2E">
                신촌 대학 연합 SW 창업 경진 대회
                <br />
                (9-12월, 신촌권 대학 4개 연합)
              </ActivityBox>
            </ActivityColumn>
      ...
      <PreLectureSection>
        <PreLectureInner>
          ...
          <PreLectureNotice>
            * 필수가 아닌 선택사항으로, 서류 지원 시 수강 내역 스크린샷을 제출할
            경우 가산점이 부여됩니다.
          </PreLectureNotice>
          ...
          <PreLectureList>
            <PreLectureItem>
              <div className="text">
                ...
                <ul>
                  <li>
                    파트 1. Elements and Structure ‘Lesson: Introduction to
                    HTML’
                  </li>
                  <li>
                    파트 1. Elements and Structure ‘Lesson: HTML Document
                    Standards’
                  </li>
                </ul>
              </div>
