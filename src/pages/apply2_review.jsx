      ...
      <Page>
        <Frame>
          <TitleBlock>
            ...
            <Subtitle className="body-regular">데이터 없음</Subtitle>
          </TitleBlock>
              ...
              <CardInner>
                <EtcGroup>
                  <EtcItem>
                    ...
                    {files?.precourse?.length > 0 && (
                      <FileList>
                        {files.precourse.map((f, idx) => (
                          <FileRow key={`pre-${idx}`}>
