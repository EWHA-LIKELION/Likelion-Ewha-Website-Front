...
function Project() {
  ...
  return (
    <>
      <Helmet>
        <title>프로젝트 | 이화여대 멋쟁이사자처럼</title>
        <meta
          name="description"
          content="이화여대 멋쟁이사자처럼의 해커톤, 졸업 프로젝트, 대동제 사이트 등 다양한 프로젝트를 확인해보세요. 아기사자와 운영진들의 창의적인 결과물을 만나보세요."
        />
        <meta
          property="og:title"
          content="프로젝트 | 이화여대 멋쟁이사자처럼"
        />
        <meta
          property="og:description"
          content="이화여대 멋쟁이사자처럼의 해커톤, 졸업 프로젝트, 대동제 사이트 등 다양한 프로젝트를 확인해보세요."
        />
        <meta
          property="og:url"
          content="https://likelion.ewha.university/project"
        />
        <link rel="canonical" href="https://likelion.ewha.university/project" />
      </Helmet>
      <ProjectWrapper>
        <Contents>
          {/*페이지 정보*/}
          <PageInfo>
            ...
            <PageLabel className="h5-regular">
              이화여대 아기사자와 운영진들의 다양한 프로젝트를 확인해보세요!
            </PageLabel>
          </PageInfo>
...
const PageBtn = styled.button`
  ...
  border: none;
  background: ${({ $active }) =>
    $active ? "var(--Cool-Neutral-98, #F4F4F5)" : "transparent"};
  color: ${({ $active }) =>
    $active ? "var(--Neutral-20)" : "var(--Neutral-70, #9B9B9B)"};
  cursor: pointer;
