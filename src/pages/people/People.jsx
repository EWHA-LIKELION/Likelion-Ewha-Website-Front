...
function People() {
  ...
  // 운영진
  const managers = filteredByGeneration.filter((m) => m.role === "운영진");
  ...
  return (
    <>
      <Helmet>
        <title>멤버 소개 | 이화여대 멋쟁이사자처럼</title>
        <meta
          name="description"
          content="이화여대 멋쟁이사자처럼 운영진과 아기사자들을 소개합니다. 기획/디자인, 프론트엔드, 백엔드 파트의 다양한 멤버들을 만나보세요."
        />
        <meta
          property="og:title"
          content="멤버 소개 | 이화여대 멋쟁이사자처럼"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://likelion.ewha.university/people"
        />
        <link rel="canonical" href="https://likelion.ewha.university/people" />
      </Helmet>
      <PeopleWrapper>
        <Container>
          <PeopleInfo>
            ...
            >
              이화여대 멋쟁이사자처럼 운영진과 아기사자들을 소개합니다!
            </p>
          </PeopleInfo>
          ...
          {lions.length > 0 && (
            <Lion>
              ...
              >
                이화여대 멋쟁이사자처럼 {selectedGeneration} {selectedPart}{" "}
                아기사자입니다.
              </p>
              ...
              <LionCardGrid style={{ marginTop: "60px" }}>
                {lions
                  .filter(
                    (m) =>
                      selectedPart === "기획•디자인" || m.part === selectedPart,
                  )
                  .map((m) => (
                    <MemberCard
                      key={m.id}
