...
const TermsDropdown = ({ question, answer, styleType = 1 }) => {
...
const Container = styled.div`
  ...
  @media (max-width: 799px) {
    border-radius: ${(props) =>
      props.$styleType === 1 ? "0.75rem" : "0.2rem"};
  }
`;
...
const SelectButton = styled.button`
  width: 100%;
  padding: ${(props) =>
    props.$styleType === 1 ? "2rem 2.5rem" : "0.75rem 1.75rem"};
  ...
  @media (max-width: 799px) {
    padding: ${(props) =>
      props.$styleType === 1 ? "1rem 1.25rem" : "0.5rem 0.88rem"};
  }
`;
...
const QuestionText = styled.span`
  ...
  text-align: left;
  color: ${(props) =>
    props.$styleType === 1 ? "var(--neutral-20)" : "var(--neutral-50)"};
`;
...
const AnswerContent = styled.div`
  padding: ${(props) => {
    ...
    return props.$styleType === 1
      ? "0 2.5rem 2rem 2.5rem"
      : "0 1.75rem 0.75rem 1.75rem";
  }};
  background: transparent;
  text-align: left;
  ...
  @media (max-width: 799px) {
    padding: ${(props) => {
      if (!props.$isOpen) return "0";
      return props.$styleType === 1
        ? "0 1.25rem 1rem 1.25rem"
        : "0 0.88rem 0.5rem 0.88rem";
    }};
  }
`;
